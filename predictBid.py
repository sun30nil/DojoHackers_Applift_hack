...
# est = AdaBoostRegressor(base_estimator=None, n_estimators=100, learning_rate=1.0, loss='linear', random_state=None)
...
print 'Avg Of Actual ', train_set[predict_col].mean()
# print predicted
